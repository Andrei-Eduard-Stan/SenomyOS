...
`scripts/generate-appearance.py` projects shared tokens into native SCSS,
Rasi, GTK CSS, QML JavaScript, and Hyprlock syntax. Generated files contain a
header and should be changed through `tokens.json`, not edited independently.
