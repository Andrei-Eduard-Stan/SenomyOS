        ...
        Repeater {
            model: [
                ...
                },
                {
                    ...
                    icon: "wifi.svg",
                    badge: "",
                    tooltip: "NetworkManager native service is scheduled for the next V2 slice"
                },
                {
                    id: "battery",
                ...
                },
                {
                    id: "tray",
                    icon: "tray-up.svg",
                    badge: SystemTray.items.values.length > 0 ? String(SystemTray.items.values.length) : "",
                    tooltip: SystemTray.items.values.length + " native tray item(s); flyout migration pending"
                }
            ]
            ...
            delegate: Item {
                ...
                Image {
                    ...
                    opacity: modelData.id === "network" ? 0.58 : 1
                }
                Rectangle {
